...
import styles from '../../assets/css/quotation/Components/thankYouPage/rating.module.css';
const Rating = () => {
    ...
    return (
        <section className="calificacion" style={{ display: showModal ? 'block' : 'none' }}>
            <div className={styles.cont_btn}>
                ...
                <button className={styles.cerrar} title="cerrar" href="#" onClick={handleCloseRating}>
